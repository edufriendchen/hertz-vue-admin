...
func (i *DBApi) InitDB(ctx context.Context, c *app.RequestContext) {
	if global.DB != nil {
	...
	if err := c.BindAndValidate(&dbInfo); err != nil {
...
func (i *DBApi) CheckDB(ctx context.Context, c *app.RequestContext) {
	var (
		message  = "前往初始化数据库"
		needInit = true
	)
