...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/controller/createApi", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/controller/getApiList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/controller/getApiById", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/controller/deleteApi", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/controller/updateApi", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/controller/getAllApis", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/controller/deleteApisByIds", V2: "DELETE"},
		...
		{Ptype: "p", V0: "8881", V1: "/controller/createApi", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/controller/getApiList", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/controller/getApiById", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/controller/deleteApi", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/controller/updateApi", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/controller/getAllApis", V2: "POST"},
		...
		{Ptype: "p", V0: "9528", V1: "/controller/createApi", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/controller/getApiList", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/controller/getApiById", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/controller/deleteApi", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/controller/updateApi", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/controller/getAllApis", V2: "POST"},
