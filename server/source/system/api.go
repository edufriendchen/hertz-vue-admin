...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "controller", Method: "POST", Path: "/controller/createApi", Description: "创建api"},
		{ApiGroup: "controller", Method: "POST", Path: "/controller/deleteApi", Description: "删除Api"},
		{ApiGroup: "controller", Method: "POST", Path: "/controller/updateApi", Description: "更新Api"},
		{ApiGroup: "controller", Method: "POST", Path: "/controller/getApiList", Description: "获取api列表"},
		{ApiGroup: "controller", Method: "POST", Path: "/controller/getAllApis", Description: "获取所有api"},
		{ApiGroup: "controller", Method: "POST", Path: "/controller/getApiById", Description: "获取api详细信息"},
		{ApiGroup: "controller", Method: "DELETE", Path: "/controller/deleteApisByIds", Description: "批量删除api"},
